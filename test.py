...
url_path_no_tag = os.path.abspath('test_data/yelp_user_no_price_cat_tag.html')
url_path_no_price = os.path.abspath('test_data/yelp_no_price_tag.html')
url_path_place = os.path.abspath('test_data/yelp_place_test_page.html')
